...
const YouTubePlayer = memo(
  ({
    ...
    const YT_URL = `https://www.youtube.com/embed/${vidId}?start=${startDuration}${
    ...
    function removeBranding() {
      const JAVASCRIPT_TO_BE_EXECUTED = `
            ...
            ${
              hideCards === true
                ? `removeThisElementBuddy(".ytp-cards-teaser");`
                : ""
            }
      ${hideTopBar === true ? `removeThisElementBuddy(".ytp-chrome-top");` : ``}
      document.querySelector(".ytp-gradient-top").remove();
      ${hideYTLogo === true ? `removeThisElementBuddy("a");` : ``}
      ${
        hideControls
      ...
      ${
        hideCards === true ? `.ytp-cards-teaser{display:none!important;}` : ""
      }${
        hideControls
